...
# ax.plot(v, color = 'blue', label = r'CD')
...
df = pd.read_csv('CD_Reward_0.csv')

df['Moving_Average'] = df.rolling(window=3, min_periods=1).mean()
plt.figure(figsize=(10, 5))
plt.plot(df, label='Original Data')
plt.plot(df['Moving_Average'], label='3-Point Moving Average', color='red')
plt.title('3-Point Moving Average of Data')
plt.xlabel('Index')
